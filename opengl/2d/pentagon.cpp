...
void drawPentagon(float centerX, float centerY, float sideLength) {
    glBegin(GL_POLYGON);
    float angle = 72.0f; // Angle between two consecutive vertices of a regular pentagon
    for (int i = 0; i < 5; i++) {
...
void display() {
    ...
    // Draw a pentagon at the center of the window with side length 0.5
